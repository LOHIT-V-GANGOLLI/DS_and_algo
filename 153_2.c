...
int main()
{
    ...
    while (1)
    {
        printf("\n1-Produce_in_Producer\n2-Consume_from_Consumer\n3-Produce_in_Consumer\n4-Consume_from_Producer\n5-Print_Producer_Consumer\n6-Get_the_Active_Producer_and_Consumer\n7-Exit\n");
        scanf("%d", &opn);
        switch (opn)
        {
        case 1:
            Produce_in_Produce(&q);
            break;
        case 2:
            Consume_from_Consume(&p);
            break;
        case 3:
            Produce_in_Consume(&p);
            break;
        case 4:
            Consume_from_Produce(&q);
            break;
        case 5:
            Print_Producer_Consumer(q, p);
            break;
        case 6:
            Get_the_Active_Producer_and_Consumer(q, p);
            break;
        case 7:
            printf("exiting\n");
            exit(0);
